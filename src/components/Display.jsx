...
export default function Display({weatherData}){
  ...
  const imageUrl = `https://openweathermap.org/img/wn/${weatherData.icon}@2x.png`
    ...
    <div className="top">
            ...
            <h5  style={{...cardTitle, fontWeight: "300", fontSize: "19px"}}>{currentdate}</h5>
    </div>
    ...
    <div className="middle" style={{display: "flex", flexDirection: "row", justifyContent: "flex-end", width:"110rem", marginTop:"20px"}}>
              ...
              <img src={imageUrl} className="card-img-top" alt="weather image" style={{height: "140px", width: "165px"}}/>
              ...
              <div className="card mt-3" style={cardStyle}>
                  ...
                  <div className="card-body" style={cardBodyStyle}>
                      ...
                      <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between", width: "100%"} }>
                          ...
                          <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/high_temp.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
                            
                            <p><span style={{fontSize: "18px"}}>{(weatherData.maxTemp- 273.15).toFixed(2)}° </span>c <br /> High</p>
                        </div>

                        <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/feelslike.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
                            
                          <p><span style={{fontSize: "18px"}}>{(weatherData.feelsLike - 273.15).toFixed(2)}° </span>c <br />Feels Like</p>
                        </div>

                        <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/pressure.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
                        ...
                        <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/low_temp.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
                            
                          <p><span style={{fontSize: "18px"}}>{(weatherData.minTemp- 273.15).toFixed(2)}°</span> c <br /> Low</p>
                        </div>

                        <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/windspeed.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
                            
                          <p> {weatherData.windspeed} m/s <br /> Wind Speed </p>
                        </div>

                        <div className="icon-details" style={{display: "flex", width: "auto", gap:"5px"}}>
                          <img src="src/assets/humidity.png" alt="weather image" style={{height: "50px", width: "52px"}}/>
